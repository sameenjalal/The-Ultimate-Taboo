...
#init_easy = ['Indiana Jones', 'Lord of the Rings', 'House MD', 'Trees', 'Jim Carrey', 'Jennifer Aniston', 'New York City', 'Harry Potter', 'Why so Serious', 'Dartmouth', 'Darth Vader', 'Mike The Situation']
init_easy=[]
