		...
		<!--	<h1><font face="Helvetica">Play Taboo Online!</font></h1>-->
				...
				<div id="buttons">
					...
					<form action="game.php" method="get">
						<input type="Submit" name="easy" value="     I Like it Easy!     " id="easy"/>
						<br>
						<br>
						<input type="Submit" name="hard" value="     I Like it Hard!     " id="hard"/>
						<br>
						<br>
						<input type="Submit" name="dirty" value="     I Like it Dirty!     " id="dirty"/>
					</form>
